"use strict";
(self["webpackChunk_fmpro_bi_engine"] = self["webpackChunk_fmpro_bi_engine"] || []).push([[9684],{
...
__webpack_require__.d(__webpack_exports__, {
  EnhancerArray: () => (/* binding */ EnhancerArray),
  MiddlewareArray: () => (/* binding */ MiddlewareArray),
  SHOULD_AUTOBATCH: () => (/* binding */ SHOULD_AUTOBATCH),
  ...
  autoBatchEnhancer: () => (/* binding */ autoBatchEnhancer),
  ...
  createActionCreatorInvariantMiddleware: () => (/* binding */ createActionCreatorInvariantMiddleware),
  ...
  createNextState: () => (/* reexport */ immer_esm/* default */.Ay),
  ...
  original: () => (/* reexport */ immer_esm/* original */.c2),
  prepareAutoBatched: () => (/* binding */ prepareAutoBatched),
  removeListener: () => (/* binding */ removeListener),
  unwrapResult: () => (/* binding */ unwrapResult)
});

// EXTERNAL MODULE: ../node_modules/.pnpm/immer@9.0.21/node_modules/immer/dist/immer.esm.mjs
var immer_esm = __webpack_require__(59563);
...
// EXTERNAL MODULE: ../node_modules/.pnpm/reselect@4.1.8/node_modules/reselect/es/defaultMemoize.js
var defaultMemoize = __webpack_require__(78904);
...
;// ../node_modules/.pnpm/@reduxjs+toolkit@1.9.7_react-redux@8.1.3_@types+react-dom@18.3.7_@types+react@18.3.27___cb0e8e0a1c9ba753385e4b0696571144/node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js
...
var createDraftSafeSelector = function () {
    ...
    var wrappedSelector = function (value) {
        ...
        return selector.apply(void 0, __spreadArray([(0,immer_esm/* isDraft */.Qx)(value) ? (0,immer_esm/* current */.ss)(value) : value], rest));
    };
...
function freezeDraftable(val) {
    return (0,immer_esm/* isDraftable */.a6)(val) ? (0,immer_esm/* default */.Ay)(val, function () {
    }) : val;
}
...
function createImmutableStateInvariantMiddleware(options) {
    ...
    // removed by dead control flow
 var _c, isImmutable, ignoredPaths, _d, warnAfter, ignore; 
    // removed by dead control flow
...
function createSerializableStateInvariantMiddleware(options) {
    ...
    // removed by dead control flow
 var _c, isSerializable, getEntries, _d, ignoredActions, _e, ignoredActionPaths, _f, ignoredPaths, _g, warnAfter, _h, ignoreState, _j, ignoreActions, _k, disableCache; 
    // removed by dead control flow
 var cache; 
    // removed by dead control flow
...
function getDefaultMiddleware(options) {
    ...
    if (false) // removed by dead control flow
{ var actionCreatorOptions, serializableOptions, immutableOptions; }
    return middlewareArray;
}
// src/configureStore.ts
...
{}
    ...
    function reducer(state, action) {
        ...
        return caseReducers.reduce(function (previousState, caseReducer) {
            if (caseReducer) {
                if ((0,immer_esm/* isDraft */.Qx)(previousState)) {
                ...
                else if (!(0,immer_esm/* isDraftable */.a6)(previousState)) {
                    ...
                    return (0,immer_esm/* default */.Ay)(previousState, function (draft) {
...
function createStateOperator(mutator) {
    return function operation(state, arg) {
        ...
        if ((0,immer_esm/* isDraft */.Qx)(state)) {
            runMutator(state);
            return state;
        }
        else {
            return (0,immer_esm/* default */.Ay)(state, runMutator);
        }
    };
}
